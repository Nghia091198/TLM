...
function listBanerSlide() {
	...
	// slider tin tuc chi tiet
	var slidepostct = new Swiper(".wrap-post-detail .wrap-post-related .swiper-container", {
		slidesPerView: 1,
		spaceBetween: 15,
		loop: true,
		navigation: {
			nextEl: ".wrap-post-detail .wrap-post-related .button-next",
			prevEl: ".wrap-post-detail .wrap-post-related .button-prev",
		},
		breakpoints: {
			320: {
				slidesPerView: 1,
